...
class MqttAppService(
        ...
        try {
            ...
            client?.setCallback(object : MqttCallback {
                ...
                override fun connectionLost(cause: Throwable?) {
                    android.util.Log.w("MQTT_APP", "Conexión perdida: ")
                }
            ...
            client?.connect(options, null, object : IMqttActionListener {
                override fun onSuccess(token: IMqttToken?) {
                    ...
                    android.util.Log.d("MQTT_APP", "✅ Conectado y suscrito a ")
                }

                override fun onFailure(token: IMqttToken?, ex: Throwable?) {
                    android.util.Log.e("MQTT_APP", "❌ Error: ")
                }
            })
        } catch (e: Exception) {
            android.util.Log.e("MQTT_APP", "❌ Error inicializando MQTT: ")
        }
    }
    ...
    private fun handleFcMessage(msg: MqttMessage) {
        try {
            ...
            val fcMsg = Json.decodeFromString<FcMessage>(jsonString)
            ...
            android.util.Log.d("MQTT_APP", "🔁 Re-publicado al TV:  bpm")
        } catch (e: Exception) {
            android.util.Log.e("MQTT_APP", "❌ Error procesando mensaje FC: ")
        }
    }
    ...
    fun disconnect() {
        try {
            ...
            android.util.Log.e("MQTT_APP", "Error desconectando: ")
        }
    }
}
