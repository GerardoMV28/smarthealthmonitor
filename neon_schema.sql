-- ====================================================================
-- PostgreSQL DDL Schema — SmartHealth Monitor (Neon Serverless)
-- Práctica: Neon Serverless + Room + Retrofit · DDI · UTNG
-- ====================================================================

-- 1. Tabla principal de lecturas de frecuencia cardíaca
...
-- 3. Tabla de dispositivos registrados
...
CREATE INDEX IF NOT EXISTS idx_lecturas_fecha ON lecturas_fc(fecha DESC);
CREATE INDEX IF NOT EXISTS idx_lecturas_dispositivo ON lecturas_fc(dispositivo);
