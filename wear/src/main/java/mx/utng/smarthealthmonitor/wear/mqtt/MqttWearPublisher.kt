...
class MqttWearPublisher(private val context: Context) {
        ...
        try {
            ...
            client?.connect(options, null, object : IMqttActionListener {
                ...
                override fun onFailure(token: IMqttToken?, ex: Throwable?) {
                    android.util.Log.e("MQTT_WEAR", "❌ Error: ")
                }
            })
        } catch (e: Exception) {
            android.util.Log.e("MQTT_WEAR", "❌ Error inicializando MQTT: ")
        }
    }
    ...
    fun publishFC(bpm: Int, estado: String) {
        ...
        try {
            ...
            android.util.Log.d("MQTT_WEAR", "📤 Publicado:  bpm → ")
        } catch (e: Exception) {
            android.util.Log.e("MQTT_WEAR", "❌ Error publicando FC: ")
        }
    }
    ...
    fun disconnect() {
        try {
            ...
            android.util.Log.e("MQTT_WEAR", "Error desconectando: ")
        }
    }
}
